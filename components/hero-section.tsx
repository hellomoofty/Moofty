...
export function HeroSection({ onGenerateClick, onViewExamples }: HeroSectionProps) {
  return (
    <section className="relative overflow-hidden bg-white">
      {/* 1. PAGYVINIMAS: Švelnūs spalvų debesys fone */}
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-20 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* KAIRĖ PUSĖ: Tavo originalus tekstas ir mygtukai */}
          ...
          {/* DEŠINĖ PUSĖ: Naujas vizualas su tavo linku */}
          <div className="relative lg:block hidden">
            <div className="relative z-10 rounded-[2rem] border-[8px] border-slate-900/5 bg-white p-2 shadow-2xl rotate-2 transition-transform duration-500 hover:rotate-0">
              <img 
                ...
                alt="Product Sheet Example" 
                className="rounded-[1.5rem] w-full h-auto shadow-sm"
              />
            </div>

            {/* Plaukiojanti kortelė gyvumui */}
