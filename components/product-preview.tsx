    ...
    <div className="relative">
      ...
      >
        ...
        <div ref={contentRef} className="relative z-10 flex flex-col flex-grow">
          {/* HEADER */}
          <div className="px-12 pt-16 pb-6 text-left">
          ...
          {/* PAGRINDINIS TURINYS */}
          <div className="px-12 pt-4 text-left flex-grow">
        ...
        {/* FOOTERIS */}
        <div 
          className="px-12 py-10 flex justify-between items-center text-white relative z-10"
